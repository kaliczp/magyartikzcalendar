% Author: Robert Krause and Péter Kalicz
% License : Creative Commons attribution license
% Original version submitted to TeXample.net on 13 July 2012
\documentclass[landscape,a3paper, hungarian, 10pt]{scrartcl}
...
\usepackage[landscape, headheight = 2cm, margin=.45cm,
...
\def\termin#1#2{
  \node [anchor=north west, text width= 3.85cm] at
    ($(cal-#1.south west)+(0em, 1em)$) {\tiny{#2}};
}
...
\calendar[
  dates=\year-03-01 to \year-12-31,
  name=cal,
  day yshift = 2 em,
  day code=
  {
    ...
    minimum height= .8cm, text width = 3.85cm, draw = gray]{\tikzdaytext};
    % Ez írja a nap nevét translator package dictionary kell a magyarhoz
    \draw (-1.7 cm, -.1ex) node[anchor = west]{\footnotesize%
  ...
  execute before day scope=
  {
    ...
    {
      % Shift right
      \pgftransformxshift{4.1cm}
      % Print month name 
      \draw (0,0)node [shape=rectangle, minimum height= .8cm,
        text width = 3.85cm, fill = lightgray, text= white, draw = red, text centered]
    ...
    \ifdate{workday}
    {
      ...
      \ifdate{between=2017-12-24 and 2018-01-01}{%
    ...
    % Christian holidays
    \ifdate{equals=2017-04-14}{\tikzset{every day/.style={fill=red!20}}}{}
    \ifdate{equals=2017-04-16}{\tikzset{every day/.style={fill=red!20}}}{}
    \ifdate{equals=2017-04-17}{\tikzset{every day/.style={fill=red!20}}}{}
    \ifdate{equals=2017-06-05}{\tikzset{every day/.style={fill=red!20}}}{}
  },
...
\termin{\year-04-14}{Nagypéntek}
\termin{\year-04-16}{Húsvét}
\termin{\year-04-17}{Húsvét}
\termin{\year-06-05}{Pünkösd}
\termin{\year-10-23}{56-os forradalom}
